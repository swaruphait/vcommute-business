...
app.controller("dashboardController", function ($scope, $http, $timeout) {
    ...
    function _autoMonthlyVisitAdmin() {
      $http({
        method: 'GET',
        url: 'dashboard/supermonthlyvisit',
    ...
    function _autoBarChartAdmin() {
      $http({
        method: 'GET',
        url: 'dashboard/superadminBarchartdata',
      }).then(function successCallback(response) {
...
function _monthlyUsesChartAdmin() {
  $http({
    method: 'GET',
    url: 'dashboard/superadminMntUsesApplication',
...
// *****************Attendance Activity Line Graph********************
  ...
  function _monthlyAttendanceChartAdmin() {
    $http({
      method: 'GET',
      url: 'dashboard/superadminMntAttndchartdata',
...
function _weekVisitChartAdmin() {
  $http({
	method: 'GET',
	url: 'dashboard/superadminWeekchartdata',
